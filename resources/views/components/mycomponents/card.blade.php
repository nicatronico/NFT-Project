...
<div class="min-w-[260px] h-[380px] bg-gray-600 text-white flex flex-col  justify-center items-center gap-y-[10px] rounded-[20px]">
    <div class="w-[230px] mb-[-20px]">
        <div class="w-[230px] h-[200px] rounded-[20px] bg-gray-900">
            <img src="{{$path}}" alt="" class="w-[230px] h-[200px] rounded-[20px]">
        </div>
    ...
    <h1 class="w-[230px] text-[12px] font-bold">{{$title}}</h1>
    ...
    <div class="flex justify-between items-center w-[230px] gap-y-[8px]">
        <div class="flex gap-x-[10px] justify-center items-center">
            ...
            <div class="w-[35px] h-[35px] rounded-[10px] bg-gray-900" >
                <img src="{{$path}}" alt="" class="w-[35px] h-[35px] rounded-[10px]">
            </div>
    ...
    <div class="w-[230px] flex items-center justify-between">
        <div>
            <span class="text-[12px] text-zinc-400">Current Bid</span>
            <div>
               
                <span class="text-[12px] font-bold leading-7">{{$price ?? '0'}} ETH</span> <span class="text-[14px] leading-7">= {{$price??""}}</span>
        ...
        <div>
            ...
            <span class="text-zinc-400 text-[14px]">View History</span>
        </div>
    </div>
</div>